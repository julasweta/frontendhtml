            ...
            if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, h = s.followFinger ? r ? t.translate : -t.translate : -i.currentTranslate, !s.cssMode)
                  if (s.freeMode) {
                        ...
                        if (s.freeModeMomentum) {
                              ...
                              if (w < t.maxTranslate()) s.freeModeMomentumBounce ? (w + t.maxTranslate() < -S && (w = t.maxTranslate() - S), b = t.maxTranslate(), C = !0, i.allowMomentumBounce = !0) : w = t.maxTranslate(), s.loop && s.centeredSlides && (T = !0);
                              else if (w > t.minTranslate()) s.freeModeMomentumBounce ? (w - t.minTranslate() > S && (w = t.minTranslate() + S), b = t.minTranslate(), C = !0, i.allowMomentumBounce = !0) : w = t.minTranslate(), s.loop && s.centeredSlides && (T = !0);
                              ...
                              s.freeModeMomentumBounce && C ? (t.updateProgress(b), t.setTransition(g), t.setTranslate(w), t.transitionStart(!0, t.swipeDirection), t.animating = !0, n.transitionEnd((function () {
      ...
      var Y = {
                        ...
                        updateSlides: function () {
                              ...
                              if (void 0 !== s) {
                                          ...
                                          if (t.slidesPerColumn > 1) {
                                                ...
                                                if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                                                      var D = Math.floor($ / (t.slidesPerGroup * t.slidesPerColumn)),
                                                            B = $ - t.slidesPerColumn * t.slidesPerGroup * D,
                                                            G = 0 === D ? t.slidesPerGroup : Math.min(Math.ceil((h - D * z * t.slidesPerGroup) / z), t.slidesPerGroup);
                                                      I = (O = B - (A = Math.floor(B / G)) * G + D * t.slidesPerGroup) + A * T / z, L.css({
                                          ...
                                          if ("none" !== L.css("display")) {
                                                if ("auto" === t.slidesPerView) {
                                                      ...
                                                      if (H && (L[0].style.transform = "none"), X && (L[0].style.webkitTransform = "none"), t.roundLengths) C = this.isHorizontal() ? L.outerWidth(!0) : L.outerHeight(!0);
                                                            ...
                                                            C = q && "border-box" === q ? Y + R + W : Y + F + V + R + W
                                                      } else {
                                                            var _ = parseFloat(N.getPropertyValue("height") || 0),
                                                            ...
                                                            C = J && "border-box" === J ? _ + K + Z : _ + j + U + K + Z
                                                      }
                                                      H && (L[0].style.transform = H), X && (L[0].style.webkitTransform = X), t.roundLengths && (C = Math.floor(C))
                                                } else C = (s - (t.slidesPerView - 1) * w) / t.slidesPerView, t.roundLengths && (C = Math.floor(C)), d[$] && (this.isHorizontal() ? d[$].style.width = C + "px" : d[$].style.height = C + "px");
                                                d[$] && (d[$].swiperSlideSize = C), c.push(C), t.centeredSlides ? (b = b + C / 2 + E / 2 + w, 0 === E && 0 !== $ && (b = b - s / 2 - w), 0 === $ && (b = b - s / 2 - w), Math.abs(b) < .001 && (b = 0), t.roundLengths && (b = Math.floor(b)), x % t.slidesPerGroup == 0 && p.push(b), u.push(b)) : (t.roundLengths && (b = Math.floor(b)), (x - Math.min(this.params.slidesPerGroupSkip, x)) % this.params.slidesPerGroup == 0 && p.push(b), u.push(b), b = b + C + w), this.virtualSize += C + w, E = C, x += 1
                                          }
                                    }
                                    ...
                                    S(this, {
                                          ...
                                          slidesGrid: u,
                                          slidesSizesGrid: c
                                    }), h !== o && this.emit("slidesLengthChange"), p.length !== g && (this.params.watchOverflow && this.checkOverflow(), this.emit("snapGridLengthChange")), u.length !== y && this.emit("slidesGridLengthChange"), (t.watchSlidesProgress || t.watchSlidesVisibility) && this.updateSlidesOffset()
                              }
                        },
                  ...
                  events: {
                        attachEvents: function () {
                              var e = r(),
                                    ...
                                    n = this.device,
                                    l = this.support;
                              this.onTouchStart = O.bind(this), this.onTouchMove = A.bind(this), this.onTouchEnd = D.bind(this), t.cssMode && (this.onScroll = N.bind(this)), this.onClick = G.bind(this);
                              var o = !!t.nested;
                              ...
                              }(t.preventClicks || t.preventClicksPropagation) && s.addEventListener("click", this.onClick, !0), t.cssMode && a.addEventListener("scroll", this.onScroll), t.updateOnWindowResize ? this.on(n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", B, !0) : this.on("observerUpdate", B, !0)
                        },
                        detachEvents: function () {
                              ...
                              }(t.preventClicks || t.preventClicksPropagation) && s.removeEventListener("click", this.onClick, !0), t.cssMode && a.removeEventListener("scroll", this.onScroll), this.off(n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", B)
                        }
                  },
                  breakpoints: {
            ...
            R = function () {
                  function t() {
                        ...
                        var l = S({}, Y);
                        n.useParams(l), n.params = S({}, l, V, i), n.originalParams = S({}, n.params), n.passedParams = S({}, i), n.params && n.params.on && Object.keys(n.params.on).forEach((function (e) {
            ...
            U = {
                  ...
                  handle: function (e) {
                        ...
                        if (s.invert && (r = -r), i.params.freeMode) {
                              ...
                              if (b.push(w), T ? (w.direction !== T.direction || w.delta > T.delta || w.time > T.time + 150) && i.mousewheel.animateSlider(w) : i.mousewheel.animateSlider(w), i.mousewheel.releaseScroll(w)) return !0
                        }
                  ...
                  setTranslate: function () {
                        ...
                        for (var c = 0; c < s.length; c += 1) {
                              ...
                              var w = Math.max(Math.min(v[0].progress, 1), -1),
                                    ...
                                    E = 0,
                                    x = 0;
                              f % 4 == 0 ? (b = 4 * -y * l, x = 0) : (f - 1) % 4 == 0 ? (b = 0, x = 4 * -y * l) : (f - 2) % 4 == 0 ? (b = l + 4 * y * l, x = l) : (f - 3) % 4 == 0 && (b = -l, x = 3 * l + 4 * l * y), n && (b = -b), h || (E = b, b = 0);
                              var T = "rotateX(" + (h ? 0 : -g) + "deg) rotateY(" + (h ? g : 0) + "deg) translate3d(" + b + "px, " + E + "px, " + x + "px)";
                              if (w <= 1 && w > -1 && (u = 90 * f + 90 * w, n && (u = 90 * -f - 90 * w)), v.transform(T), d.slideShadows) {
                                    var C = h ? v.find(".swiper-slide-shadow-left") : v.find(".swiper-slide-shadow-top"),
                                          S = h ? v.find(".swiper-slide-shadow-right") : v.find(".swiper-slide-shadow-bottom");
                                    0 === C.length && (C = m('<div class="swiper-slide-shadow-' + (h ? "left" : "top") + '"></div>'), v.append(C)), 0 === S.length && (S = m('<div class="swiper-slide-shadow-' + (h ? "right" : "bottom") + '"></div>'), v.append(S)), C.length && (C[0].style.opacity = Math.max(-w, 0)), S.length && (S[0].style.opacity = Math.max(w, 0))
                              }
                        }
                        if (i.css({
            ...
            he = {
                  setTranslate: function () {
                        for (var e = this.width, t = this.height, i = this.slides, s = this.slidesSizesGrid, a = this.params.coverflowEffect, r = this.isHorizontal(), n = this.translate, l = r ? e / 2 - n : t / 2 - n, o = r ? a.rotate : -a.rotate, d = a.depth, h = 0, p = i.length; h < p; h += 1) {
                              ...
                              Math.abs(E) < .001 && (E = 0), Math.abs(b) < .001 && (b = 0), Math.abs(y) < .001 && (y = 0), Math.abs(f) < .001 && (f = 0), Math.abs(g) < .001 && (g = 0), Math.abs(x) < .001 && (x = 0);
                              var T = "translate3d(" + E + "px," + b + "px," + y + "px)  rotateX(" + g + "deg) rotateY(" + f + "deg) scale(" + x + ")";
...
function openForm() {
      document.getElementById("myForm").style.display = "block", document.getElementById("myForm").style.position = "fixed", document.getElementById("myForm").style.bottom = 0, document.getElementById("myForm").style.zIndex = 1
}
...
for (console.log(price[0].textContent), i = 0; i < 3; i++) "free" == price[i].textContent && (price[i].style.color = "rgb(30, 175, 19)");
var menu = document.querySelector("#menu_nav"),
      navbar = document.querySelector("#navbar");

function menu_close() {
      var e = document.getElementById("menu_nav");
      document.getElementById("navbar").style.display = "block", e.style.display = "none"
}
...
navbar.addEventListener("click", (function () {
      console.log("Navbar"), "none" == menu.style.display ? menu.style.display = "block" : menu.style.display = "none"
}));
